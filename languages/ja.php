...
$messages['ja'] = array(
		...
		'text-intro' => "
<p>これは、ウィキメディアの国際会議「<a href='http://wikimania2012.wikimedia.org'>ウィキマニア2012</a>」への参加に関する補助申請です。</p>
<p>スカラーシップでは、2012年7月12日から15日までワシントンで開かれるウィキマニアへの参加費、宿泊費および交通費が支給されます。</p>
...
<p>申し込み期限は<strong>2012年2月16日</strong>です。</p>",
		...
		'form-lang-version' => "ウィキメディアのどの言語版を一番使用しますか？",
		...
		'form-future-explain' => "以下のスペースで、どのように/なぜウィキマニアへの参加が、あなたの将来のウィキメディア運動への関与を変えるのかについて説明してください。",
		...
		'form-travel-conditions' => "補助を受け取ることができた場合、私はa)ウィキメディア財団が推奨する旅行予約サービスを使用し費用を直接支払う、b)自分自身でウィキメディア財団による費用見積り以下で予約し補助を受け取るために領収書を提出する、のどちらかに同意します。",
...
ウィキマニアスカラーシップチーム",
		'mock' => "これはスカラーシップ申請の模擬試験サイトです。試験のためのみに使用してください。",
